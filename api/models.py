...
class List(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)  # Use DateTimeField for 'created_at'
    name = models.CharField(max_length=100)  # Use CharField for 'name' as text
...
class Todo(models.Model):
    ...
    description = models.TextField()  # Use TextField for 'description' as text
    completed = models.BooleanField(default=False)  # Use BooleanField for 'completed'
    created_by = models.CharField(max_length=36)  # Use CharField for 'created_by' as text
